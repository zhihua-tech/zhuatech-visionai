...
export const domain={
 ...
 tagline:'让每一张质检图像，都对应清晰的质量结论',storyTitle:'模型负责发现异常，<br/>质量人员负责最终放行',storyText:'把机器视觉的速度与人工质量判断结合起来，保留图像、模型、规则和复核证据。',pattern:[2,4,7,10,13,16,19,22,25,28,31],loginStats:[['18','视觉工位'],['96.4%','自动判定率'],['46','待复核样本']],loginTitle:'视觉质量运营中心',adminDemo:'工位 / 模型 / 质量',fieldDemo:'样本 / 复核 / 放行',upgrade:{eyebrow:'V1.1 模型运营',title:'三信号视觉模型漂移监测',summary:'联合观察缺陷率、平均置信度和人工复核分歧，按稳定、观察、再训练三级状态给出处置建议。',api:'POST /api/ai/vision/monitor-drift',metrics:[['4.7pp','缺陷率漂移'],['12.0pp','置信度下降'],['RETRAIN','诊断状态']]}
}
